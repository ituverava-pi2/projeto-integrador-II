...
function changeLanguage(idioma) {
  if (idioma === 'br') {
    ...
    document.getElementById('title-atend').innerHTML = 'Atendimento ao público'
  ...
  if (idioma === 'en') {
    ...
    document.getElementById('title-page').innerHTML = 'In the Focus of Dengue'
  ...
  if (idioma === 'es') {
    ...
    document.getElementById('title-page').innerHTML = 'En el Foco del Dengue'
